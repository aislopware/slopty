//! File transfer, the host's half: where an upload lands, and writing it so that a cut never
...
impl Transfers {
    ...
    /// Bytes of `name` the host holds durably: all of them once it landed, else what its
    /// partial file holds.
